...
{
    Async.Deferred.Failure.apply(this, arguments);
};

Failure.prototype = new Async.Deferred.Failure();
Failure.prototype.constructor = Failure;

var JsonDecodeFailure = function(value, message)
{
    Async.Deferred.Failure.apply(this, arguments);
};
...
var XmlDecodeFailure = function(value, message)
{
    Async.Deferred.Failure.apply(this, arguments);
};
...
QueryDict.prototype.append = function(values)
{
    var self = this;
...
Response.prototype.jsonParse = function(accept_null)
{
    ...
    if (!this.body && !accept_null)
        return new JsonDecodeFailure(this.body, "empty data");
    ...
    try {
        ...
        return new JsonDecodeFailure(this.body, "invalid data");
    }
};
...
Response.prototype.xmlParse = function(accept_null)
{
    ...
    if (!this.body && !accept_null)
        return new XmlDecodeFailure(this.body, "empty data");
    ...
    try {
        ...
        return new XmlDecodeFailure(this.body, "invalid data");
    }
};
...
var CacheEntry = function(cache, txn, response)
{
    ...
    if (cc) {
        ...
        this.expire = Date.now() + parseInt(e) * 1000;
    }
...
{
    return this.expire < Date.now() && !this.forced;
};
...
function get(url)
{
    return new Transaction({ url: url }).send();
}
